...
from .APC40_MkII_Dennis import APC40_MkII_Dennis

def create_instance(c_instance):
    return APC40_MkII_Dennis(c_instance)


def get_capabilities():
    return {CONTROLLER_ID_KEY: controller_id(vendor_id=2536, product_ids=[41], model_name=u'Akai APC40 MkII Dennis'),
